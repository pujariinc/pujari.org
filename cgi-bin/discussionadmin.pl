#!/usr/local/bin/perl
##############################################################################
# DiscussionBoard Admin                Version 2.0 ALPHA 2.1                        #
...
#                                                                            #
# DiscussionBoard may be used and modified free of charge by anyone so long as      #
...
$basedir = "/home/pujari-a/public_html/discussion";
$baseurl = "http://www.pujari-atlanta.org/discussion";
$cgi_url = "http://www.pujari-atlanta.org/cgi-bin/discussionadmin.pl";

$mesgdir = "message";
$datafile = "data.txt";
$mesgfile = "discussionboard.html";
...
#   discussionboard.html document.  It can give you a better idea of whether or  #
#   not you want to remove the whole thread or just part of it.           #
###########################################################################

if ($command eq 'remove') {
   print "<html><head><title>Remove Messages From DiscussionBoard</title></head>\n";
   print "<body><center><h1>Remove Messages From DiscussionBoard</h1></center>\n";
...
#   added to the discussionboard.html document.                                  #
###########################################################################

elsif ($command eq 'remove_by_num') {
   print "<html><head><title>Remove Messages From DiscussionBoard By Number</title></head>\n";
   print "<body><center><h1>Remove Messages From DiscussionBoard By Number</h1></center>\n";
   print "Select below to remove those postings you wish to remove.\n";
   print "Checking the Input Box on the left will remove the whole thread\n";
...
###########################################################################
   ...
   print "<html><head><title>Remove Messages From DiscussionBoard By Date</title></head>\n";
   print "<body><center><h1>Remove Messages From DiscussionBoard By Date</h1></center>\n";
   print "Select below to remove those postings you wish to remove.\n";
...
###########################################################################
   ...
   print "<html><head><title>Remove Messages From DiscussionBoard By Author</title></head>\n";
   print "<body><center><h1>Remove Messages From DiscussionBoard By Author</h1></center>\n";
...
###########################################################################
   ...
   print "<html><head><title>Change DiscussionBoard Admin Password</title></head>\n";
   print "<body><center><h1>Change DiscussionBoard Admin Password</h1></center>\n";
...
###########################################################################
   ...
   open(discussionBOARD,">$basedir/$mesgfile");
   print discussionBOARD @lines;
   close(discussionBOARD);      
...
###########################################################################
   ...
   print "<html><head><title>DiscussionAdmin For DiscussionBoard</title></head>\n";
   print "<body bgcolor=#FFFFFF text=#000000><center><h1>DiscussionAdmin For DiscussionBoard</h1></center>\n";
   print "Choose your Method of modifying DiscussionBoard Below:<p>\n";
...
sub return_html {
   ...
   if ($type eq 'remove') {
      ...
      print "<html><head><title>DiscussionBoard DiscussionAdmin Password Changed</title></head>\n";
      print "<body><center><h1>DiscussionBoard DiscussionAdmin Password Changed</h1></center>\n";
      print "Your Password for DiscussionBoard DiscussionAdmin has been changed!  Results are below:<p><hr size=7 width=75%><p>\n";
...
sub passwd_trailer {
   print "<hr size=7 width=75%><center><font size=-1>\n";
   print "[ <a href=\"$cgi_url\">DiscussionAdmin</a> ] [ <a href=\"$baseurl/$mesgpage\">$title</a> ]\n";
   print "</font></center><hr size=7 width=75%>\n";
   print "</body></html>\n";
}
