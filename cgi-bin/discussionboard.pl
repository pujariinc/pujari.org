#!/usr/local/bin/perl
##############################################################################
# discussionBoard                      Version 2.0 ALPHA 2.1                        #
...
$cgi_url = "http://www.pujari-atlanta.org/cgi-bin/discussionboard.pl";
...
# Open the Main discussionBoard File to add link
&main_page;
...
sub get_variables {
   ...
   if ($FORM{'followup'}) {
      ...
      # message 'discussionBoard Vulnerability' posted by Samuel Sparling Nov-09-1998.
...
sub new_file {
   ...
   print NEWFILE "<p>\n";
   print NEWFILE "Link URL: <input type=text name=\"url\" size=50><br>\n";
   print NEWFILE "Link Title: <input type=text name=\"url_title\" size=48><br>\n";
   print NEWFILE "Image URL: <input type=text name=\"img\" size=49><p>\n";
...
###############################
# Main discussionBoard Page Subroutine
...
sub rest_of_form {
   ...
   print "$FORM{'body'}\n";
   print "</textarea><p>\n";
   print "Link URL: <input type=text name=\"url\" value=\"$FORM{'url'}\" size=45><br>\n";
   print "Link Title: <input type=text name=\"url_title\" value=\"$FORM{'url_title'}\" size=50><br>\n";
   print "Image URL: <input type=text name=\"img\" value=\"$FORM{'img'}\" size=45><p>\n";
